...
- 前端单元测试: 107 个（ProblemList, CommunityPage, Home, Login, Register, authStore 等）
- Server 单元测试: 141 个（errorHandler, validate, leaderboard, points, achievements 等）
- E2E 测试: 90 个（题目详情、社区帖子、个人资料、竞赛详情、认证流程等）
